    ...
    public lcmtypes.hkd_problem_data_lcm_t copy()
    {
        ...
        for (int a = 0; a < 4; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.contacts[a], 0, outobj.contacts[a], 0, (int) this.n_timesteps);        }
 
        outobj.times = new float[(int) n_timesteps];
        if (this.n_timesteps > 0)
            System.arraycopy(this.times, 0, outobj.times, 0, (int) this.n_timesteps); 
        outobj.pos_r = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.pos_r[a], 0, outobj.pos_r[a], 0, (int) this.n_timesteps);        }
 
        outobj.eul_r = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.eul_r[a], 0, outobj.eul_r[a], 0, (int) this.n_timesteps);        }
 
        outobj.vel_r = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.vel_r[a], 0, outobj.vel_r[a], 0, (int) this.n_timesteps);        }
 
        outobj.omega_r = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.omega_r[a], 0, outobj.omega_r[a], 0, (int) this.n_timesteps);        }
 
        outobj.qdummy_r = new float[(int) 12][(int) n_timesteps];
        for (int a = 0; a < 12; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.qdummy_r[a], 0, outobj.qdummy_r[a], 0, (int) this.n_timesteps);        }
 
        outobj.pos = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.pos[a], 0, outobj.pos[a], 0, (int) this.n_timesteps);        }
 
        outobj.eul = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.eul[a], 0, outobj.eul[a], 0, (int) this.n_timesteps);        }
 
        outobj.vel = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.vel[a], 0, outobj.vel[a], 0, (int) this.n_timesteps);        }
 
        outobj.omega = new float[(int) 3][(int) n_timesteps];
        for (int a = 0; a < 3; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.omega[a], 0, outobj.omega[a], 0, (int) this.n_timesteps);        }
 
        outobj.qdummy = new float[(int) 12][(int) n_timesteps];
        for (int a = 0; a < 12; a++) {
            if (this.n_timesteps > 0)
                System.arraycopy(this.qdummy[a], 0, outobj.qdummy[a], 0, (int) this.n_timesteps);        }
