...
class hkd_data_lcmt(object):
    __slots__ = ["mpctime", "contact", "p", "vWorld", "rpy", "omegaBody", "qJ", "foot_placements"]

    __typenames__ = ["double", "int32_t", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [None, [4], [3], [3], [3], [3], [12], [12]]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">d", self.mpctime))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x84404d6ac9f35f78) & 0xffffffffffffffff
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", hkd_data_lcmt._get_packed_fingerprint())[0]
