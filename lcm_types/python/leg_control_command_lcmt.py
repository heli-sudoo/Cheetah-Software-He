...
class leg_control_command_lcmt(object):
    __slots__ = ["tau_ff", "f_ff", "q_des", "qd_des", "p_des", "v_des", "kp_cartesian", "kd_cartesian", "kp_joint", "kd_joint", "microtime"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[12], [12], [12], [12], [12], [12], [12], [12], [12], [12], None]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">f", self.microtime))
    ...
    def _decode_one(buf):
        ...
        self.microtime = struct.unpack(">f", buf.read(4))[0]
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if leg_control_command_lcmt in parents: return 0
        tmphash = (0xbfdbf5ab25a4a515) & 0xffffffffffffffff
