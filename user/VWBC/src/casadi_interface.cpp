...
#include <assert.h>
template<typename T>
void casadi_interface(std::vector<const T *> ARG, std::vector<T *> RES, int max_sz_res,
...
template void casadi_interface<double>(std::vector<const double *> ARG, std::vector<double *> RES, int max_sz_res,
