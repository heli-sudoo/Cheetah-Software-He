...
p_FR = addPlot()
addSignalSequence("DEBUG_HKDMPC", msg.times, msg.qdummy[0], plot=p_FR)

p_FL = addPlot()
addSignalSequence("DEBUG_HKDMPC", msg.times, msg.qdummy[3], plot=p_FL)

p_HR = addPlot()
addSignalSequence("DEBUG_HKDMPC", msg.times, msg.qdummy[6], plot=p_HR)

p_HL = addPlot()
addSignalSequence("DEBUG_HKDMPC", msg.times, msg.qdummy[9], plot=p_HL)
