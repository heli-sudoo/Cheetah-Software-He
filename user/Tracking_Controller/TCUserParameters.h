#ifndef PROJECT_TRACKING_CONTROL_USERPARAMETERS_H
#define PROJECT_TRACKING_CONTROL_USERPARAMETERS_H

#include "ControlParameters/ControlParameters.h"

class TCUserParameters : public ControlParameters {
public:
  TCUserParameters()
  ...
  DECLARE_PARAMETER(double, use_fly_wheels);
...
#endif //PROJECT_TRACKING_CONTROL_USERPARAMETERS_H
